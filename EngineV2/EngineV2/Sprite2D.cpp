...
Sprite2D::Sprite2D(const Sprite2D& other)
{
}
...
bool Sprite2D::Render(ID3D11DeviceContext* deviceContext, float positionX, float positionY)
{
	bool result;
...
bool Sprite2D::UpdateBuffers(ID3D11DeviceContext* deviceContext, float positionX, float positionY)
{
...
void Sprite2D::RenderBuffers(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
void Sprite2D::SetScale(D3DXVECTOR2 scale)
{
	this->Scale = scale;
}
